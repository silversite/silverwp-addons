...
if ( ! class_exists( 'SilverWpAddons\Widget\RecentVideo' ) ) {
	/**
	 * Recent Posts Widget
	 *
	 ...
	 */
	class RecentVideo extends WidgetAbstract {
		public function __construct() {

			$widget_options = array(
				'description' => Translate::translate( 'Most recent single Video Post.' ),
			);
			parent::__construct(
				'silverwp-recent-video',
				Translate::translate( 'SilverWp Recent Video' ),
				$widget_options
			);
			...
			$title->setDefault( Translate::translate( 'Video' ) );
