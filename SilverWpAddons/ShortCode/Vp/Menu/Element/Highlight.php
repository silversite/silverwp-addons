 ...
 */
class Highlight extends ElementAbstract
{
    ...
    {
        $colors = $this->data('silverwp_get_sc_highlight_color');
        $attributes = array(
            $this->radio('color', Translate::translate('Colour'), $colors),
        );
        $elements = $this->addElement(Translate::translate('Highlight'), $attributes);
        return $elements;
    }
    /**
