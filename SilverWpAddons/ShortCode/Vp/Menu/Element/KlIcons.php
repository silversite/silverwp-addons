...
/*
  Repository path: $HeadURL: https://svn.nq.pl/wordpress/branches/dynamite/igniter/wp-content/themes/igniter/lib/SilverWpAddons/ShortCode/Generator/Menu/Element/KlIcons.php $
  Last committed: $Revision: 2057 $
  Last changed by: $Author: padalec $
  Last changed date: $Date: 2015-01-09 16:07:01 +0100 (Pt, 09 sty 2015) $
  ID: $Id: KlIcons.php 2057 2015-01-09 15:07:01Z padalec $
 */
 ...
 * @version $Id: KlIcons.php 2057 2015-01-09 15:07:01Z padalec $
 * @category WordPress
 * @package SilverWpAddons
 * @subpackage SilverWpAddons\ShortCode\Generator\Menu\Element
 * @copyright (c) 2009 - 2014, SilverSite.pl
 */
class KlIcons extends ElementAbstract
{
    protected $name = 'klico';
    ...
    public function createElements()
    {
        ...
        $attributes = array(
            $this->fontklicon('icon', Translate::translate('Name')),
            $this->radio('colour', Translate::translate('Colour'), $colors),
        );
        $elements = $this->addElement(Translate::translate('KlIcons'), $attributes);
        return $elements;
    }
    /**
     * Client
