...
/*
  Repository path: $HeadURL: https://svn.nq.pl/wordpress/branches/dynamite/igniter/wp-content/themes/igniter/lib/SilverWpAddons/ShortCode/Generator/Menu/Element/Timeline.php $
  Last committed: $Revision: 2057 $
  Last changed by: $Author: padalec $
  Last changed date: $Date: 2015-01-09 16:07:01 +0100 (Pt, 09 sty 2015) $
  ID: $Id: Timeline.php 2057 2015-01-09 15:07:01Z padalec $
 */
 ...
 * @version $Id: Timeline.php 2057 2015-01-09 15:07:01Z padalec $
 * @category WordPress
 * @package SilverWpAddons
 * @subpackage SilverWpAddons\ShortCode\Generator\Menu\Element
 * @copyright (c) 2009 - 2014, SilverSite.pl
 */
class Timeline extends ElementAbstract {
    ...
    public function createElements() {
        ...
        $elements   = $this->addElement( Translate::translate( 'Timeline' ), $attributes );

        return $elements;
    }

    /**
     * Timline content item short code replace method
     *
    ...
    public function shortCode( $args, $content ) {
        $Timeline   = \SilverWpAddons\PostType\Timeline::getInstance();
        $query_data = $Timeline->getQueryData( 0 );
