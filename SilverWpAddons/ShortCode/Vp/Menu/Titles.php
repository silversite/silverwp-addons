 ...
 */
class Titles extends MenuAbstract
{
    public function getTitle()
    {
        $title = Translate::translate('Titles');
        return $title;
    }
    
    public function createMenuElement()
    {
        $this->addElement(Element\TitleLarge::getInstance());
        $this->addElement(Element\TitleMedium::getInstance());
        $this->addElement(Element\TitleSmall::getInstance());
    }
}
